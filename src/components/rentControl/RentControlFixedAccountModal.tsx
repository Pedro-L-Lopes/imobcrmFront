...
const RentControlFixedAccountModal: React.FC<{ propertyId: string }> = ({
  propertyId,
}) => {
          ...
          return (
            <div key={account.contaFixaId} className="border-b py-2">
              <div className="flex items-center justify-between w-full p-1 gap-2">
                <div className="grid grid-cols-1 md:grid-cols-4 items-center justify-between w-full gap-2">
...
export default RentControlFixedAccountModal;
